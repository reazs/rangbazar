              ...
              var Rive = (() => {
                ...
                return function(Rive2) {
                  ...
                  const fa = new function() {
                    function b() {
                      if (!a) {
                        ...
                        var t = document.createElement("canvas"), v = { alpha: 1, depth: 0, stencil: 0, antialias: 0, premultipliedAlpha: 1, preserveDrawingBuffer: 0, preferLowPowerToHighPerformance: 0, failIfMajorPerformanceCaveat: 0, enableExtensionsByDefault: 1, explicitSwapControl: 1, renderViaOffscreenBackBuffer: 1 };
                        let q = t.getContext("webgl2", v);
                        if (q)
                          c = 2;
                        else if (q = t.getContext("webgl", v))
                          c = 1;
                        else
                    ...
                    this.bb = function(t, v, q, E, I) {
                      if (b()) {
                        var w = l.push(t), z = k.push(v);
                        if (a.canvas.width != w || a.canvas.height != z)
                          a.canvas.width = w, a.canvas.height = z;
                        ...
                        w = 0;
                        for (var J of q)
                          a.bufferSubData(a.ARRAY_BUFFER, w, J.Aa), w += 4 * J.Aa.length;
                        console.assert(w == 4 * E);
                        for (var P of q)
                          a.bufferSubData(a.ARRAY_BUFFER, w, P.Ra), w += 4 * P.Ra.length;
                        ...
                        for (const y of q) {
                          ...
                          y.rb ? (a.scissor(y.Ea, z - y.Fa - y.Ka, y.yb, y.Ka), P = true) : P && (a.scissor(0, z - v, t, v), P = false);
                          q = 2 / t;
                          const da = -2 / v;
                  ...
                  Rive2.onRuntimeInitialized = function() {
                    ...
                    const e = Rive2.RenderPath, f = Rive2.RenderPaint, h = Rive2.Renderer, g = Rive2.StrokeCap, l = Rive2.StrokeJoin, k = Rive2.BlendMode, p = d.fill, r = d.stroke, t = Rive2.FillRule.evenOdd;
                    let v = 1;
                    var q = Rive2.RenderImage.extend("CanvasRenderImage", { __construct: function() {
                    ...
                    } }), E = e.extend("CanvasRenderPath", { __construct: function() {
                      this.__parent.__construct.call(this);
                      this.ga = new Path2D();
                    }, rewind: function() {
                      this.ga = new Path2D();
                      ...
                      if (null != G) {
                        ...
                        for (let U = 0, L = K.length; U < L; U++)
                          A = K[U], D.addColorStop(A.stop, a(A.color));
                        this.Da = D;
                        this.oa = null;
                      }
                      switch (B) {
                  ...
                  if (ka || la)
                    la ? x = self.location.href : "undefined" != typeof document && document.currentScript && (x = document.currentScript.src), _scriptDir && (x = _scriptDir), 0 !== x.indexOf("blob:") ? x = x.substr(0, x.replace(/[?#].*/, "").lastIndexOf("/") + 1) : x = "", la && (oa = (b) => {
                  ...
                  function ya(b, a, c) {
                    ...
                    for (c = a; b[c] && !(c >= d); )
                      ++c;
                    if (16 < c - a && b.buffer && xa)
                      return xa.decode(b.subarray(a, c));
                    for (d = ""; a < c; ) {
                      var e = b[a++];
                      if (e & 128) {
                        var f = b[a++] & 63;
                  ...
                  function Sa() {
                    if (!ra && (ka || la)) {
                      if ("function" == typeof fetch && !N.startsWith("file://"))
                        return fetch(N, { credentials: "same-origin" }).then(function(b) {
                          if (!b.ok)
                  ...
                  var eb = void 0, V = {};
                  function fb(b, a) {
                    for (void 0 === a && Q("ptr should not be undefined"); b.$; )
                      a = b.na(a), b = b.$;
                    return a;
                  }
                  var gb = {};
                  ...
                  function Kb(b, a, c) {
                    for (; a !== c; )
                      a.na || Q("Expected null or instance of " + c.name + ", got an instance of " + a.name), b = a.na(b), a = a.$;
                    return b;
                  }
                  function Lb(b, a) {
                    if (null === a)
                      return this.wa && Q("null is not a valid " + this.name), 0;
                  ...
                  function Nb(b, a) {
                    ...
                    if (this.qa)
                      switch (void 0 === a.U.aa && Q("Passing raw pointer to smart pointer is illegal"), this.xb) {
                        case 0:
                  ...
                  function Tb(b, a) {
                    function c(f) {
                      e[f] || gb[f] || (Db[f] ? Db[f].forEach(c) : (d.push(f), e[f] = true));
                    }
                    var d = [], e = {};
                    a.forEach(c);
                  ...
                  function Ub(b, a, c, d, e) {
                    ...
                    for (c = 1; c < a.length; ++c)
                      if (null !== a[c] && void 0 === a[c].ba) {
                        g = true;
                        break;
                      }
                    var l = "void" !== a[0].name, k = f - 2, p = Array(k), r = [], t = [];
                    return function() {
                      ...
                      for (var q = 0; q < k; ++q)
                        p[q] = a[q + 2].toWireType(t, arguments[q]), r.push(p[q]);
                      q = d.apply(null, r);
                      if (g)
                        Ab(t);
                      else
                        for (var E = h ? 1 : 2; E < a.length; E++) {
                          var I = 1 === E ? v : p[E - 2];
                  ...
                  function cc(b, a) {
                    ...
                    c <<= 1;
                    if (32 < c - b && bc)
                      return bc.decode(H.subarray(b, c));
                    c = "";
                    for (d = 0; !(d >= a / 2); ++d) {
                      var e = Ba[b + 2 * d >> 1];
                      if (0 == e)
                  ...
                  function mc(b, a) {
                    for (var c = Array(b), d = 0; d < b; ++d)
                      c[d] = kb(M[a + 4 * d >> 2], "parameter " + d);
                    return c;
                  }
                  var nc = [], oc = [null, [], []];
                  Za = m.BindingError = Ya("BindingError");
                  m.count_emval_handles = function() {
                    for (var b = 0, a = 5; a < O.length; ++a)
                      void 0 !== O[a] && ++b;
                    return b;
                  };
                  m.get_first_emval = function() {
                    for (var b = 5; b < O.length; ++b)
                      if (void 0 !== O[b])
                        return O[b];
                    return null;
                  };
                  ...
                  Gb.prototype.isAliasOf = function(b) {
                    if (!(this instanceof Gb && b instanceof Gb))
                      return false;
                  ...
                  Gb.prototype.clone = function() {
                    this.U.W || Fb(this);
                    if (this.U.ma)
                      return this.U.count.value += 1, this;
                    var b = yb, a = Object, c = a.create, d = Object.getPrototypeOf(this), e = this.U;
                    b = b(c.call(a, d, { U: { value: { count: e.count, ka: e.ka, ma: e.ma, W: e.W, X: e.X, aa: e.aa, ca: e.ca } } }));
                    b.U.count.value += 1;
                    b.U.ka = false;
                    return b;
                  };
                  ...
                  Pb.prototype.fromWireType = function(b) {
                    ...
                    var c = this.hb(b);
                    if (!c)
                      return this.Ga(b), null;
                    var d = ub(this.V, c);
                    if (void 0 !== d) {
                      if (0 === d.U.count.value)
                        return d.U.W = c, d.U.aa = b, d.clone();
                      d = d.clone();
                      this.Ga(b);
                      return d;
                    }
                    ...
                    return null === e ? a.call(this) : this.qa ? xb(d.V.ea, { X: d, W: e, ca: this, aa: b }) : xb(d.V.ea, { X: d, W: e });
                  };
                  Sb = m.UnboundTypeError = Ya("UnboundTypeError");
                  var sc = { G: function(b, a, c) {
                    b = T(b);
                    a = kb(a, "wrapper");
                    c = $a(c);
                    ...
                    b = Va(b, function() {
                      e.$.Ma.forEach(function(k) {
                        if (this[k] === h[k])
                          throw new ab("Pure virtual function " + k + " must be implemented in JavaScript");
                      }.bind(this));
                    ...
                    f.__construct = function() {
                      ...
                      p.ma = true;
                      Object.defineProperties(this, { U: { value: p } });
                      yb(this);
                      k = p.W;
                      k = fb(e, k);
                    ...
                    W([b], f, (h) => {
                      var g = {};
                      e.forEach((l, k) => {
                        var p = h[k], r = l.ib, t = l.jb, v = h[k + e.length], q = l.ub, E = l.wb;
                        g[l.eb] = { read: (I) => p.fromWireType(r(t, I)), write: (I, w) => {
                          var z = [];
                    ...
                    W([b, a, c], d ? [d] : [], function(q) {
                      ...
                      q = Va(v, function() {
                        if (Object.getPrototypeOf(this) !== w)
                          throw new Za("Use 'new' to construct " + p);
                        if (void 0 === z.ia)
                          throw new Za(p + " has no accessible constructor");
                        var P = z.ia[arguments.length];
                        if (void 0 === P)
                          throw new Za("Tried to invoke ctor of " + p + " with invalid number of parameters (" + arguments.length + ") - expected (" + Object.keys(z.ia).toString() + ") parameters instead!");
                        return P.apply(this, arguments);
                      });
                      var w = Object.create(I, { constructor: { value: q } });
                      q.prototype = w;
                      var z = new Jb(p, q, w, t, E, f, g, k);
                      E = new Pb(p, z, true, false);
                      I = new Pb(p + "*", z, false, false);
                      var J = new Pb(p + " const*", z, false, true);
                    ...
                    W([], [b], function(g) {
                      ...
                      if (void 0 !== g.V.ia[a - 1])
                        throw new Za("Cannot register multiple constructors with identical number of parameters (" + (a - 1) + ") for class '" + g.name + "'! Overload resolution is currently only performed using the parameter count, not actual type info!");
                      g.V.ia[a - 1] = () => {
                    ...
                    Y(b, { name: a, fromWireType: f, toWireType: c, argPackAdvance: 8, readValueFromPointer: ac(a, e, 0 !== d), ba: null });
                  }, g: function(b, a, c) {
                    function d(f) {
                      f >>= 2;
                      var h = M;
                    ...
                    Y(b, { name: a, fromWireType: function(d) {
                      ...
                      if (c && h) {
                        ...
                        for (h = 0; h < f; ++h)
                          k = e.charCodeAt(h), 255 < k && (jb(l), Q("String has UTF-16 code units that do not fit in 8 bits")), H[l + h] = k;
                      else
                        for (h = 0; h < f; ++h)
                          H[l + h] = e[h];
                      null !== d && d.push(jb, g);
                    ...
                    if (2 === a) {
                      ...
                      4 === a && (d = fc, e = gc, f = hc, h = () => M, g = 2);
                    Y(b, { name: c, fromWireType: function(l) {
                      for (var k = M[l >> 2], p = h(), r, t = l + 4, v = 0; v <= k; ++v) {
                        var q = l + 4 + v * a;
                        if (v == k || 0 == p[q >> g])
                          t = d(t, q - t), void 0 === r ? r = t : (r += String.fromCharCode(0), r += t), t = q + a;
                      }
                      jb(l);
                      return r;
                    }, toWireType: function(l, k) {
                    ...
                    zb[b] = { name: T(a), xa: Z(c, d), ha: Z(e, f), Ja: [] };
                  }, K: function(b, a, c, d, e, f, h, g, l, k) {
                    zb[b].Ja.push({ eb: T(a), kb: c, ib: Z(
                      d,
                      e
                    ), jb: f, vb: h, ub: Z(g, l), wb: k });
                  }, F: function(b, a) {
                    a = T(a);
                    ...
                    var f = Array(b - 1);
                    e = lc((h, g, l, k) => {
                      for (var p = 0, r = 0; r < b - 1; ++r)
                        f[r] = c[r + 1].readValueFromPointer(k + p), p += c[r + 1].argPackAdvance;
                      h = h[g].apply(h, f);
                      for (r = 0; r < b - 1; ++r)
                        c[r + 1].Za && c[r + 1].Za(f[r]);
                      if (!d.nb)
                        return d.toWireType(l, h);
                    });
                    return nc[a] = e;
                  }, p: function(b) {
                    b = jc(b);
                  ...
                  (function() {
                    ...
                    (function() {
                      return ra || "function" != typeof WebAssembly.instantiateStreaming || Pa() || N.startsWith("file://") || "function" != typeof fetch ? c(a) : fetch(N, { credentials: "same-origin" }).then(function(e) {
...
// ../node_modules/rive-react/dist/index.js
var require_dist = __commonJS({
  "../node_modules/rive-react/dist/index.js"(exports) {
...
//# sourceMappingURL=rive-react.js.map
